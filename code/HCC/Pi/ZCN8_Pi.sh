#!/bin/bash
#SBATCH --partition=batch,jclarke
#SBATCH --ntasks-per-node=4
#SBATCH --nodes=1
#SBATCH --time=40:00:00
#SBATCH --mem-per-cpu=10G
#SBATCH --job-name=pi
#SBATCH --error=job/ZCN8.%A_%a.out
#SBATCH --output=job/ZCN8.%A_%a.err
...
picard -Xmx35g SortVcf TMP_DIR=/scratch/ \
...
--bed_file mdWind.bed \
--n_cores 4 \
--output_folder PI_Genes \
--output_prefix ZCN8_PI \
--chromosomes ${chr} \
